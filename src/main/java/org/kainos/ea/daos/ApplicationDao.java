...
public class ApplicationDao {
    ...
    public int createApplication(Application application) throws SQLException {
        ...
        try {
            ...
            insertPaymentDetails(c, paymentDetails);
            ...
            insertPreviousPassports(c, previousPassports);

            Nationality nationality = application.getApplicant().getNationality();
            insertNationality(c, nationality);
            ...
            insertFacialImage(c, facialImage);

            Name name = application.getApplicant().getName();
            insertName(c, name);

            Applicant applicant = application.getApplicant();
            insertApplicant(c, applicant);
    ...
    private void insertDelivery(Connection c, Delivery delivery) throws SQLException {
        ...
        PreparedStatement ps = c.prepareStatement(sqlDelivery, Statement.RETURN_GENERATED_KEYS);
    ...
    private void insertPaymentDetails(Connection c, PaymentDetails paymentDetails) throws SQLException {
        ...
        PreparedStatement ps = c.prepareStatement(sqlPaymentDetails, Statement.RETURN_GENERATED_KEYS);
    ...
    private void insertProduct(Connection c, Product product) throws SQLException {
        String sqlProduct = "INSERT INTO products (braille_sticker, extra_large_passport, service_level) VALUES (?, ?, ?)";
        PreparedStatement ps = c.prepareStatement(sqlProduct, Statement.RETURN_GENERATED_KEYS);
    ...
    private void insertPreviousPassports(Connection c, PreviousPassports previousPassports) throws SQLException {
        String sqlPreviousPassports = "INSERT INTO previous_passports (application_passport_id) VALUES (?)";
        PreparedStatement ps = c.prepareStatement(sqlPreviousPassports, Statement.RETURN_GENERATED_KEYS);
    ...
    private void insertNationality(Connection c, Nationality nationality) throws SQLException {
        String sqlNationality = "INSERT INTO nationalities (dual_national) VALUES (?)";
        PreparedStatement ps = c.prepareStatement(sqlNationality, Statement.RETURN_GENERATED_KEYS);
    ...
    private void insertFacialImage(Connection c, FacialImage facialImage) throws SQLException {
        ...
        PreparedStatement ps = c.prepareStatement(sqlFacialImage, Statement.RETURN_GENERATED_KEYS);
    ...
    private void insertName(Connection c, Name name) throws SQLException {
        String sqlName = "INSERT INTO names (surname, forenames) VALUES (?, ?)";
        PreparedStatement ps = c.prepareStatement(sqlName, Statement.RETURN_GENERATED_KEYS);
    ...
    private void insertApplicant(Connection c, Applicant applicant) throws SQLException {
        ...
        PreparedStatement ps = c.prepareStatement(sqlApplicant, Statement.RETURN_GENERATED_KEYS);
